...
public class LockedDoor : MonoBehaviour, ISwappable
{
    ...
    private const int LOCKED_R = 73;
    private const int LOCKED_UR = 57;
    private const int LOCKED_UL = 56;
    private const int LOCKED_L = 72;
    private const int LOCKED_DL = 88;
    private const int LOCKED_DR = 89;
